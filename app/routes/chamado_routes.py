...
def listar_chamados():
    ...
    chamados_json = [{"id": c.id, "titulo": c.titulo, "tipo": c.tipo , "categoria": c.categoria, "data_criacao": c.data_criacao,
                      "usuario_id": c.usuario_id} for c in chamados]
...
def criar_usuario():
    ...
    novo_chamado = Chamado(titulo=dados["titulo"], tipo=dados["tipo"], categoria=dados["categoria"], usuario_id=dados["usuario_id"])
